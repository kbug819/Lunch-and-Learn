...
describe UnsplashService do
  it "returns 10 images related to search" do
    ...
    VCR.use_cassette("unsplash_images_#{search_term}") do
      ...
      expect(images[0][:urls][:raw]).to eq("https://images.unsplash.com/photo-1528181304800-259b08848526?ixid=M3w1MDU1OTR8MHwxfHNlYXJjaHwxfHxUaGFpbGFuZHxlbnwwfHx8fDE2OTk5MDkxMTd8MA&ixlib=rb-4.0.3")
